...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="U_read.php"><i class='bx bx-spreadsheet'></i>Read</a></li>
                                        ...
                                        <center>
                                            <fieldset>
                                                ...
                                                if (!isset($_POST["txtCPF"])) {
                                                    ?>
                                                    <form name="frmExcluir" method="POST" action="U_read.php">
                                                        <br>
                                                        <br>
                                                        ...
                                                        <div class="btnfor">
                                                            <input type="submit" value="Procurar" name="pesquisar">
                                                        </div>
                                                    ...
                                                    if (mysqli_num_rows($res) == 0) {
                                                        ...
                                                        ?>
                                                        <form method="POST" action="U_read.php">
                                                            <br>
		 ...
		 style='color:black;'>$CPF</p>"; ?> </p></b><br><br>
                                                            ...
                                                            <div class="btnfor">
                                                                <center>
                                                                    ...
                                                                    <a href="U_read.php">Voltar ao Consultar</a>
                                                                </center>
                                                            </div>
                                                            <br>
                                                        </form>
