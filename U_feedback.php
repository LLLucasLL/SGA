...
<body>
    ...
    <div class="sidebar">
        ...
        <li><a href="pagina_protegida.php"><i class='bx bxs-dashboard'></i>Dashboard</a></li>
            ...
            <br>
            <br>
            <li class="active"><a href="U_feedback.php"><i class='bx bxs-add-to-queue'></i>Feedback</a></li>
            <br>
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row['ID'] . "</td>";
                echo "<td>" . htmlspecialchars($row['FED_NOME']) . "</td>";
                echo "<td>" . htmlspecialchars($row['FED_EMAIL']) . "</td>";
                echo "<td class='descricao'>" . htmlspecialchars($row['FED_ASSUNTO']) . "</td>";
                echo "<td>" . htmlspecialchars($row['FED_DESCRICAO']) . "</td>";                
                echo "<td>" . $row['FED_DATA'] . "</td>";
                echo "</tr>";
            }
        } else {
